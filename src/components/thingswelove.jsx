    ...
    <div className="twl-page" id="things-we-love">
      ...
      <div className="twl-hero">
        ...
        <div className="twl-hero-content">
          ...
          <p className="twl-subtitle">All the little things that are ours — our songs, our spots, our everything.</p>
      ...
      {!loading && !error && entries.length === 0 && (
        <div className="twl-empty-state">
          <div className="twl-empty-icon">♥</div>
          <h2 className="twl-empty-title">Our favorites are on their way...</h2>
          <p className="twl-empty-text">From our go-to food to the songs that remind us of each other —<br />everything we love will live right here.</p>
        </div>
      )}
